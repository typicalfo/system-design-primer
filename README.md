...
[Pattern cards](patterns/README.md) · [Templates](templates/README.md) · [Reference architectures](enterprise/reference-architectures/README.md) · [What's dated](enterprise/whats-dated.md)

## Use it in Cursor or Claude Code in 60 seconds

Clone this fork, then install a skill by symlink or by copy. Repeat for `threat-modeler`, `cost-estimator`, `design-reviewer`, and `adr-writer`. Symlink stays in sync with the clone. Copy is self-contained: links inside the skill folder stay relative, and links that leave the folder point at GitHub.
...
| Kind | Count |
|---|---:|
| [Enterprise docs](enterprise/README.md) | 94 |
| [AI docs](enterprise/ai/README.md) | 6 |
| [Reference architectures](enterprise/reference-architectures/README.md) | 5 |
| [Pattern cards](patterns/README.md) | 38 |
| [Templates](templates/README.md) | 11 |
| [Skills](pack/README.md) | 5 |
| Total catalogued docs | 166 |
